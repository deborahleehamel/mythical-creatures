...
class StringTest < Minitest::Homework
  ...
  def test_check_if_all_caps
   refute false, "abc".upcase == "abc"
   assert_equal "ABC".upcase, "ABC"
   assert_equal true, "Hæ?".upcase == "Hæ?"
 end
  ...
  def test_end_with
    ...
    refute false, "coffee".end_with?("x")
